      ...
      <div className="w-[90%] mx-auto py-8">
        ...
        <div className="mt-12">
          <div className="flex items-center mb-4">
            ...
            />
            <label htmlFor="default-checkbox" className="ms-2 text-white font-light">
            I confirm that I uploaded valid government issued ID. This form includes  my actual Name, address, picture and my gender.
            </label>
          </div>
          <div className="flex items-center mb-4">
            <input
